...
// }];
//
// const queryParamPrefixFor = (language: string) => `?${language}=`;
//
// const retrieve = () => {
//   function fromQueryParam(language: string) {
...
//   }
//
//   // WTH? There's some retarded automatic semicolon insertion going on, actively causing bugs. Hence the parens.
//   // Wonderful!
//   return (
...
// };
//
// const generateShareableUrl = (language: string, code: string) =>
//   window.location.origin +
//   window.location.pathname +
//   queryParamPrefixFor(language) +
//   compress(code);
//
// const persist = debounce((language: string, code: string) => {
//   try {
...
//
// // Defines the interface of the properties of the ShareButton component
...
//         <span className={showConfirmation ? "tooltip s-show-confirmation" : "tooltip"}>
...
//   reason: string;
//   reasonSyntaxError: string;
// }
//
// // tslint:disable-next-line: max-classes-per-file
// export default class Try extends React.Component<ITryProps, {}> {
//   state: ITryProps = {
//     autoEvaluate: true,
//     js: "// loading",
//     jsIsLatest: false,
...
//     this.evalWorker.onmessage = (data: ICompilerOutput) => {
//       if (data.type === "end") {
